...
public class ExamController extends BaseController {
    ...
    @GetMapping("/list")
    public String getExamListPage(HttpServletRequest httpServletRequest, @RequestParam(defaultValue = "0") int page, Model model) {
        int pageSize = 5;
    ...
    @GetMapping("/search")
    public String searchExams(HttpServletRequest httpServletRequest, @RequestParam("searchQuery") String searchQuery,
        ...
        return renderPage(httpServletRequest, model, "exam", "search");
    }

    @GetMapping("/update/{id}")
    public String showUpdateForm(HttpServletRequest httpServletRequest, @PathVariable("id") Long id, Model model) {
        ExamEntity exam = examService.findById(id);
        model.addAttribute("exam", exam);
        return renderPage(httpServletRequest, model, "exam", "update");
    }
